      ...
      <div class="edrea_tm_about">
        <div class="left">
          <div class="image">
            ...
            <div class="main" data-img-url="img/about/zat.png"></div>
          </div>
        </div>
        <div class="right">
          <div class="short">
            <h3 class="name">Izzat <span class="coloring">Zainuddin</span></h3>
            <h3 class="job">
              <AnimationText />
            </h3>
          </div>
          <div class="text">
            <p>
              My name is <span>Izzat.</span> I am a graphic designer, and
